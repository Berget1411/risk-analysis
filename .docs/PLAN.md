...
1. Vilka variabler är viktigast för skadefrekvensen enligt Poisson-GLM, och hur ska effekterna tolkas i försäkringsteknisk och affärsmässig kontext? Exempelvis att är geografi viktigare än branch .
